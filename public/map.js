...
const afterAnimate = e => {
    ...
    if (!chart.get('flight-route')) {
        ...
        chart.addSeries({
            ...
            data: [{
                geometry: {
                    type: 'LineString',
                    coordinates: [
                        [-60.01524569695899,-3.1026724067810654 ], // Amsterdam
                        [ -79.86492725211505,9.243626515342715,],
                        [ 2.397774637880851,38.43400431351013],
                        [ 49.33136927176543,9.478581794485901],
                        [127.90558240159392,37.18416288617935]
                    ]
                },
        ...
        chart.addSeries({
            ...
            data: [
                    { name: 'Manaus, BR', geometry: {type: 'Point', coordinates: [-60.01524569695899,-3.1026724067810654 ]} }, 
